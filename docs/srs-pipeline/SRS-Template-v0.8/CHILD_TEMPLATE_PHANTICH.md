...
> Sơ đồ điều hướng giữa các màn hình tham số, xem trước và kết xuất. Không có màn hình thì ghi “Không áp dụng”.
...
> Bắt buộc với báo cáo gửi cơ quan quản lý: nêu rõ cách chứng minh con số đúng — tổng kiểm soát, đối chiếu chéo với báo cáo khác, so với kỳ trước.
