# TỔNG HỢP: THIẾT LẬP VÀ CHỈNH SỬA JOB

## Tính năng [FEAT-HTVH-036-05A] Thiết lập Job (Tạo mới)
...
![Trình tự — Thiết lập mới và cập nhật cấu hình Job](diagrams/FUNC-HTVH-036_seq-05a.png)

> *Hình: Trình tự — Thiết lập mới và cập nhật cấu hình Job.* Nguồn PlantUML: [FUNC-HTVH-036_seq-05.puml](diagrams/FUNC-HTVH-036_seq-05a.puml) · bản vector: [FUNC-HTVH-036_seq-05.svg](diagrams/FUNC-HTVH-036_seq-05a.svg)
...
## Tính năng [FEAT-HTVH-036-05B] Chỉnh sửa cấu hình Job (Cập nhật)
...
![Trình tự — Thiết lập mới và cập nhật cấu hình Job](diagrams/FUNC-HTVH-036_seq-05b.png)

> *Hình: Trình tự — Thiết lập mới và cập nhật cấu hình Job.* Nguồn PlantUML: [FUNC-HTVH-036_seq-05.puml](diagrams/FUNC-HTVH-036_seq-05b.puml) · bản vector: [FUNC-HTVH-036_seq-05.svg](diagrams/FUNC-HTVH-036_seq-05b.svg)
