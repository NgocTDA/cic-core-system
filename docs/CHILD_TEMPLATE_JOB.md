...
> Cơ chế kích hoạt: theo lịch / theo sự kiện / thủ công. Cửa sổ thời gian quan trọng khi job nặng, tránh giờ cao điểm. Đây là thuộc tính của TIẾN TRÌNH — một chức năng một lịch. Cần nhiều lịch độc lập thì tách thành nhiều chức năng, không thêm tính năng.
