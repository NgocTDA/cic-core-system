...
const SendBalanceFormPage: React.FC = () => {
  ...
  const getAutoGeneratedFileName = useCallback((
    loaiTep: string,
    maDauMoi: string,
  ...
  }, [uploadPhanLoai, uploadNgayBaoCao, data, uploadMaDauMoi, reportKey, generateEmptyDetails, customDetailsMap, getAutoGeneratedFileName]);
  ...
  }, [importPhanLoai, importNgayBaoCao, importMaDauMoi, importFile, importModalVisible, getAutoGeneratedFileName]);
